                                ...
                                <div class="panel-body col-sm-offset-1">
                                    <div class="tab-base">
                                        ...
                                        <div class="tab-content">
                                            @foreach (@$languages as $key => $languageTab)
                                                @php
                                                    $translations = @$about->translations ?? array();
                                                @endphp
                                                @foreach ($translations as $translation)
                                                    @if ($translation->locale == $languageTab->locale)
                                                        @php
                                                            $record_about = $translation;
                                                        @endphp
                                                    @endif
                                                @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <label class="control-label">
                                                                {!! trans('backend.about.content') !!} <span class="text-danger"> (*)</span>
                                                            </label>
                                                            <textarea class="my-ckeditor"
                                                                      name="content[{{ @$languageTab->id }}]">{!! @$record_about->content ? $record_about->content : @old('content.'.@$languageTab->id) !!}</textarea>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="meta_title[{{ @$languageTab->id }}]" class="form-control"
                                                                   ...
                                                                   value="{{ @$record_about->meta_title ? $record_about->meta_title: @old('meta_title.'.@$languageTab->id) }}">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="meta_keyword[{{ @$languageTab->id }}]" class="form-control"  placeholder="{!! trans('backend.seo.meta_keyword') !!}"
                                                                   value="{{ @$record_about->meta_keyword ? $record_about->meta_keyword: @old('meta_keyword.'.@$languageTab->id) }}">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            >{!! @$record_about->meta_description ? $record_about->meta_description: @old('meta_description.'.@$languageTab->id) !!}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            @endforeach

                        ...
                        <div class="pad-btm form-inline">
                            <div class="row">
                                <div class="col-sm-6 table-toolbar-left">
                                    <a href="{{ route('products.create') }}" id="demo-btn-addrow" class="btn btn-purple">
                        ...
                        <div class="table-responsive">
                            <table id="category-table" class="table table-bordered table-hover table-vcenter">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">{!! trans('backend.product.image') !!}</th>
                                    <th class="sorting"
                                ...
                                <tr ng-repeat="(key, product) in data.products">
                                    <td style="width: 50px" class="text-center">
                                        <input type="checkbox" ng-model="checker.checkedAll[product.id]">
                                    </td>
                                    <td style="width: 50px"  class="text-center"> @{{ (data.page.current_page - 1) * data.page.per_page + key + 1 }} </td>
                                    <td class="text-center" style="width: 150px;">
                                        <img class="img-md img-circle mar-btm my-thumbnail" ng-src="{{ url('') }}/@{{ product.image }}" alt="@{{ product.name }}">
                                    </td>
                                    <td> @{{ product.name }} </td>
                                    <td style="width: 150px;">
                                        <input ng-click="actions.changeStatus(product.id)" class="is-sw-checked" type="checkbox" ng-checked="(product.status == '{{ App\Libs\Configs\StatusConfig::CONST_AVAILABLE }}')">
